...
INSERT INTO `areas` VALUES (1,'Kung fu panda 2',20000,'active'),(2,'Idiomas editado',15001,'active'),(3,'preicfes',15000,'active'),(4,'tati',15000,'active'),(5,'Asfdasdf',1231,'active'),(6,'Asfdasdf',1231,'active'),(7,'Asfdasdf',1231,'active'),(8,'Asfdasdf',1231,'active'),(9,'Artes plasticas editadas',15001,'inactive'),(10,'Artes',15000,'active'),(11,'Artes',15000,'active'),(12,'Mecanica',10000,'active'),(13,'Calculos',15000,'active'),(14,'Calculos',15000,'active');
...
-- Dump completed on 2024-04-16  8:07:49
