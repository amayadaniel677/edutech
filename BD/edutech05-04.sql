...
INSERT INTO `people_area` VALUES (1,3,4,'inactive'),(1,3,5,'active'),(1,3,6,'active'),(1,3,7,'active'),(1,3,8,'active'),(1,3,9,'inactive'),(1,3,10,'active'),(1,3,11,'active'),(2,45,12,'active'),(2,40,13,'active'),(2,40,14,'active'),(12,44,15,'inactive'),(12,40,16,'active'),(12,40,17,'active'),(12,40,18,'active'),(12,40,19,'active'),(12,40,20,'active'),(12,40,21,'active'),(12,40,22,'active'),(12,40,23,'active'),(12,40,24,'active'),(12,40,25,'active'),(12,40,26,'active'),(2,45,27,'active'),(2,45,28,'active'),(2,45,29,'active'),(1,3,30,'active'),(1,42,31,'active'),(1,40,32,'inactive'),(1,42,33,'active'),(1,3,34,'active'),(1,3,35,'active'),(1,3,36,'active'),(1,3,37,'inactive'),(1,3,38,'inactive'),(2,9,39,'active'),(1,3,40,'active'),(2,13,41,'active'),(3,9,42,'active');
...
INSERT INTO `subject_sale` VALUES (1,22000,1,1,1,7,'active'),(2,44000,2,2,2,7,'active'),(3,22000,1,1,1,7,'active'),(4,22000,1,2,1,7,'active'),(5,22000,1,1,1,8,'active'),(6,44000,2,2,2,8,'active'),(7,22000,1,1,1,8,'active'),(8,22000,1,2,1,8,'active'),(9,22000,1,1,1,9,'active'),(10,44000,2,2,2,9,'active'),(11,22000,1,1,1,9,'active'),(12,22000,1,2,1,9,'active'),(13,22000,1,1,1,10,'active'),(14,44000,2,2,2,10,'active'),(15,22000,1,1,1,10,'active'),(16,22000,1,2,1,10,'active'),(106,44000,2,2,2,76,'active'),(107,22000,1,1,1,77,'active'),(108,66000,3,1,3,78,'active'),(109,264000,12,1,12,78,'active'),(110,55555,5,1,5,79,'active'),(111,666666,20,2,20,79,'active');
...
INSERT INTO `subjects` VALUES (1,'calculo','calculo diferencial para universitarios','8 am',1,'active'),(2,'algebra','lineal y factorizacion','5 am',1,'active');
