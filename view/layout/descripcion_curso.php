<section class="content">
    ...
    <div class="row">
        ...
        <div class="col-12 col-sm-6">
            ...
            <?php endif; ?>
            <a type="button" href='https://wa.me/+573123467007?text=Hola,%20Estoy%20interesado%20en%20sus%20cursos%20'
                class="btn-animado animacion-cuatro color-instagram">
                <!-- icono whatsapp -->
                        ...
                        <div class="modal-body">
                            <form action="" method="POST" enctype="multipart/form-data" id='form-actualizarCurso'>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="descripcion" name="descripcion" placeholder=""
                                        required><?php echo $curso['description']; ?></textarea>
                                </div>
                                <div class="form-group">
