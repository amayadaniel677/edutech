    ...
    <?php if (isset($curso1) && is_array($curso1)) : ?>
        <div class="row">
            ...
            <div class="col-12 col-sm-6">
                ...
                <?php
                if ($_SESSION['rol_session'] == 'administrador' || $_SESSION['rol_session'] == 'superadmin') {
                    echo ' <br>';
                            ...
                            <div class="modal-body">
                                <form action="" method="POST" enctype="multipart/form-data" id='form-actualizarCurso'>
                                    <div class="text-center">
                                        <img class="img-fluid d-block mx-auto" src="<?php echo $ruta_inicio . $curso['photo']; ?>" alt="foto curso" style='max-width:30%'>
                                    </div>
                                    <input type="hidden" name="id" id="id" value="<?php echo $id_curso; ?>">
                                    <div class="form-group">
                                        <label for="nombre">Nombre</label>
                                        <input type="text" class="form-control" id="nombre" name="nombre" value="<?php echo $curso['name']; ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="descripcion">Descripción</label>
                                        <textarea class="form-control" id="descripcion" name="descripcion" placeholder="" required><?php echo $curso['description']; ?></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="temas">Temas</label>
                                        <textarea class="form-control" id="temas" name="temas" placeholder="" required><?php echo $curso['topics']  ?></textarea>
                                    ...
                                    <div class="d-flex justify-content-between mt-5">
                                        <button type="submit" class="btn btn-primary" id='btn-actualizarCurso'>Guardar
                                            cambios</button>
            ...
            <div class="row mt-4">
                ...
                <div class="tab-content p-3" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="product-desc" role="tabpanel" aria-labelledby="product-desc-tab">
                        <?php echo $curso1['description']; ?></div>
                    <div class="tab-pane fade" id="product-comments" role="tabpanel" aria-labelledby="product-comments-tab">
                        <h3>Recomendaciones para seguir un curso</h3>
                        <ol>
                            <li><strong>Establece objetivos claros:</strong> Antes de comenzar el curso, define qué es lo que
                                esperas lograr al finalizarlo.</li>
