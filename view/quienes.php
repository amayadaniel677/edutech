  ...
  ?>
        ...
        <div class="inicio">
            <div class="contenido">
                ...
                <div class="box">
                    ...
                    <div class="orden">
                        <button class="punto_decorativo"></button>
                        <p class="texto_botones">EXPERIENCIA</p>
                    </div>
                    <div class="orden">
                        <button class="punto_decorativo"></button>
                        <p class="texto_botones">ECONOMÍA</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="about">
        ...
        <figure class="about_img">
            <img src="../resource/img/imagen_quienes/Rectangle 8.png" class="about_pictore">
        </figure>
        <figure class="about_img about_img--left">
            <img src="../resource/img/imagen_quienes/Rectangle 10.png" class="about_pictore">
        </figure>
        <div class="about_text">
            <div class="about_ala">
