      ...
      <div class="">
          ...
          <div class="card">
            <div class="card-body login-card-body">
              <h1 class="login-box-msg ">Eliminar Usuario </h1>
              ...
              <div class="text-center mt-4 ">
                <h5>¿Estas seguro de eliminar el Usuario?</h5>
              </div>

              <div class="cuerpo-eliminar text-center float center justify-conten-center mt-4">
                <a href="controller_buscar_usuario.php?idEliminar=<?php echo $id_usuario; ?>" class="btn btn-danger ">Confirmar</a>
