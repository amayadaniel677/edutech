                                        ...
                                        <div class="col-md-12">
                                            <div class="table-responsive">
                                                <table class="table table-striped">
                                                    ...
                                                    <tbody>
                                                        <?php foreach ($detalles_abono as $detalle) : ?>
                                                            <tr>
                                                                <td><?php echo htmlspecialchars($detalle['id_venta']); ?>
                                                                </td>
                                                                <td><?php echo htmlspecialchars($detalle['valor_abonado']); ?>
                                                                </td>
                                                                <td><?php echo htmlspecialchars($detalle['fecha_abono']); ?>
                                                                </td>
