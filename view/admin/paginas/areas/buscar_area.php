    ...
    <div class="wrapper">
                        ...
                        ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <button type="button" class="btn btn-outline-primary  mt-3"
                                                data-toggle="modal" data-target="#crearAreaModal">
       ...
       ";
                              if ($areaSelect['status'] == 'active') {
                                ...
                                echo "<a href='controller_eliminar_area.php?id_area=" . $areaSelect['id'] . "' class='btn btn-danger btn-sm ml-4'><i class='fas fa-trash'></i></a>
      ";
                              } else {
                                echo "<a href='controller_activar_area.php?id_area=" . $areaSelect['id'] . "' class='btn btn-success btn-sm ml-4'><i class='fas fa-check'></i></a>
        ";
                              }
                            } else {
                    ...
                    ?>
                        ...
                        <div class="col-12">
                            ...
                            <!-- modal editar -->
                            <!-- Modal -->
                            <div class="modal fade" id="modal-edit-area" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form action="" method='POST' id='form-edit'>
                                                <div class="form-group">
                                                    <input required type="text" name="idArea" id="idArea"
                                                        class="form-control" value="<?php if (isset($area)) {
                                                                                                              echo $areaSelect['id'];
                                                                                                            } ?>">
            ...
            <div class="modal fade" id="crearAreaModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="nombre_area" id="nombre_area"
                                            placeholder="Escriba el nombre" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="nombre_area_2" class="col-sm-4 col-form-label">Confirmar nombre del
                                        Area: </label>
                                    <div class="col-sm-8">
                                        <input type="text" name="nombre_area_2" id="nombre_area_2"
                                            placeholder="Confirmar el nombre" class="form-control">
                                    </div>
                                </div>

                                <div class="form-group text-center ">
                                    <button type="submit" id='btn-agregar-area'
                                        class="btn btn-primary btn-md w-50 mt-3">Agregar</button>
                                </div>
                            </form>
                        </div>
                        <div class="modal-footer">
