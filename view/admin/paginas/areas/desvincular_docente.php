    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0"> Desvincular Docente</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item active">Desvincular</li>
              </ol>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid "  style="max-width:1000px;">
            ...
            <div class="card">
              <div class="card-body login-card-body">
                <h1 class="login-box-msg ">Desvincular Docente </h1>
                ...
                <div class="cuerpo-eliminar text-center float center justify-conten-center mt-4">
                  <form action="" method="POST">
                    <input type="hidden" name="id_post" value="<?php echo $id_people_area;?>">
                    <input type="submit" value="Confirmar" class="btn btn-danger ">
                    <a href="controller_buscar_area.php" class="btn btn-success ">Cancelar</a>
                  </form>
                </div>
